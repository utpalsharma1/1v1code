  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        // `active` lasts the length of a match, so it is a resting state and
        // gets no glow; the player-colored border already separates it from
        // `idle`. `winner` is a one-shot event and keeps the flare.
